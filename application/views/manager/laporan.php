<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            <form method="get" action="<?= site_url('manager/laporan') ?>">
                <div class="row">
                    <div class="col-md-3">
                ...
                <a href="<?= site_url('manager/laporan') ?>" class="btn btn-secondary btn-sm">Reset</a>
                <a href="<?= site_url('manager/laporan_cetak') 
